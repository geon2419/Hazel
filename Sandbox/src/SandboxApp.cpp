...
class ExampleLayer : public Hazel::Layer
{
  public:
    ExampleLayer() : Layer("Example"), m_Camera(-1.6f, 1.6f, -0.9f, 0.9f), m_CameraPosition(0.0f, 0.0f, 0.0f)
    {
        ...
        std::string textureColorShaderVertexSource = R"(
			#version 330 core
        ...
        std::string textureColorShaderFragmentSource = R"(
			#version 330 core
        ...
        m_TextureShader.reset(Hazel::Shader::Create(textureColorShaderVertexSource, textureColorShaderFragmentSource));
